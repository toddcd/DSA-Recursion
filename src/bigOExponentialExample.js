//Algorithms with exponential time complexity (O(2^n)) have running times
// that grow rapidly with any increase in input size. For an input of size 2,
// an exponential time algorithm will take 2^2 = 4 time. With an input of size 10,
// the same algorithm will take 2^10 = 1024 time, and with an input of size 100,
// it will take 2^100 = 1.26765060022823 * 1030 time. Yikes!
